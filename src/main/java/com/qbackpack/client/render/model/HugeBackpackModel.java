...
public final class HugeBackpackModel extends AbstractBackpackModel {
    public static final ModelLayerLocation LAYER = new ModelLayerLocation(
            new ResourceLocation(QBackpack.MOD_ID, "huge_backpack"), "main");
    public static final ResourceLocation TEXTURE = new ResourceLocation(
            QBackpack.MOD_ID, "textures/entity/huge_backpack.png");

    public HugeBackpackModel(ModelPart root) {
        super(root);
    }
