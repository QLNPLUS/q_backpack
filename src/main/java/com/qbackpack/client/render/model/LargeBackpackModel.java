...
public final class LargeBackpackModel extends AbstractBackpackModel {
    public static final ModelLayerLocation LAYER = new ModelLayerLocation(
            new ResourceLocation(QBackpack.MOD_ID, "large_backpack"), "main");
    public static final ResourceLocation TEXTURE = new ResourceLocation(
            QBackpack.MOD_ID, "textures/entity/large_backpack.png");
