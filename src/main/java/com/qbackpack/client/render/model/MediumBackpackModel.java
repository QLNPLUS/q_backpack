...
public final class MediumBackpackModel extends AbstractBackpackModel {
    public static final ModelLayerLocation LAYER = new ModelLayerLocation(
            new ResourceLocation(QBackpack.MOD_ID, "medium_backpack"), "main");
    public static final ResourceLocation TEXTURE = new ResourceLocation(
            QBackpack.MOD_ID, "textures/entity/medium_backpack.png");

    public MediumBackpackModel(ModelPart root) {
        super(root);
    }
